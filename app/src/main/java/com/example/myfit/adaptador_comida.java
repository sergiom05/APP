...
public class adaptador_comida extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NotNull ViewGroup parent) {
        ...
        modelo mItem = (modelo) this.items.get(position);
    ...
    public adaptador_comida(@NotNull Context mCtx, int resources, @NotNull List items) {
